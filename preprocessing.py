...
inputs:
    ...
    input_seq_df: filed that should contain a column called 'modified codons' which has the nucleotide seq we want to match
...
for merged_reads_output_name, read_descriptor in zip(merged_reads_output_names, read_descriptors):
    ...
    possible_sequences = seq_df['modified_codons'].values.tolist()
